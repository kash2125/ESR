        ...
        with _db_conn() as conn:
            conn.executemany(
                ...
                INSERT OR REPLACE INTO projects (
                    ...
                    sales_person, start_date, projected_end_date, description, created_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                [
                    (
                        row["project_number"], row["project_name"], row["engineer"], row["project_status"],
                        row["sales_person"], row["start_date"], row["projected_end_date"], row["description"], row["created_at"]
                    )
